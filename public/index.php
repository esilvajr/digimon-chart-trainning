...
require_once("../atlas/vendor/autoload.php");
...
try {
    ...
    //$digitalWorld = new \Digimon\Chart\DigitalWorld(new \ORM\Atlas\Repositories\DigimonRepository(), new \ORM\Atlas\Repositories\DigiEvolutionRepository());
